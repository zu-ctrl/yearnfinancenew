...
const YvaultRoi = ({ theme, address, classes, t }) => {
      ...
      <div className={classes.descriptionContainer}>
        <div className={classes.valueContainer}>
          <Typography className={classes.cellTitle} variant="h5">
            {t("yvaultRoi.earnings")}:<span className={classes.description}>{getDataProp("earnings")}</span>
          </Typography>
          <Typography className={classes.cellTitle} variant="h5">
            {t("yvaultRoi.netDeposits")}:<span className={classes.description}>{getDataProp("netDeposits")}</span>
          </Typography>
        </div>
        <div className={classes.valueContainer}>
          <Typography className={classes.cellTitle} variant="h5">
          ...
          <Typography className={classes.cellTitle} variant="h5">
            IRR {t("yvaultRoi.annualized")}:<span className={classes.description}>{getDataProp("irrAnnualized")}</span>
          </Typography>
        </div>
        <div className={classes.valueContainer}>
          <Typography className={classes.cellTitle} variant="h5">
            {t("yvaultRoi.simpleReturn")}:<span className={classes.description}>{getDataProp("simpleReturn")}</span>
          </Typography>
          <Typography className={classes.cellTitle} variant="h5">
            {t("yvaultRoi.simpleReturnAnnualized")}:
...
export default withNamespaces()(withStyles(styles)(withTheme(YvaultRoi)));
