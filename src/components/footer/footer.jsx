...
class Footer extends Component {
  ...
  render() {
    const { classes, location, themeName, theme, setTheme, currentLang, setCurrentLang, langList, t } = this.props;
...
export default withNamespaces()(withRouter(withStyles(styles)(withTheme(Footer))));
