          ...
          <div className={classes.portfolioContainer}>
            <div className={classes.titleBalance} onClick={this.balanceClicked}>
              {currency === 'USD' && (
                <Typography variant={'h2'}>
                  $ {parseFloat(dashboard.portfolio_balance_usd.toFixed(2)).toLocaleString()}
                </Typography>
              )}
              {currency === 'ETH' && (
                <div className={classes.inline}>
                  <Typography variant={'h2'} noWrap>
                    {parseFloat(dashboard.portfolio_balance_eth.toFixed(2)).toLocaleString()}
                  </Typography>
            ...
            {growth === 0 && (
              <div className={classes.titleBalance} onClick={this.growthClicked}>
                {currency === 'USD' && (
                  <Typography variant={'h2'}>
                    $ {parseFloat(dashboard.portfolio_growth_usd_daily.toFixed(2)).toLocaleString()}
                  </Typography>
                )}
                {currency === 'ETH' && (
                  <div className={classes.inline}>
                    <Typography variant={'h2'} noWrap>
                      {parseFloat(dashboard.portfolio_growth_eth_daily.toFixed(2)).toLocaleString()}
                    </Typography>
                    <Typography className={classes.symbol} variant={'h3'}>
                      ETH
                    </Typography>
            ...
            {growth === 1 && (
              <div className={classes.titleBalance} onClick={this.growthClicked}>
                {currency === 'USD' && (
                  <Typography variant={'h2'}>
                    $ {parseFloat(dashboard.portfolio_growth_usd_weekly.toFixed(2)).toLocaleString()}
                  </Typography>
                )}
                {currency === 'ETH' && (
                  <div className={classes.inline}>
                    <Typography variant={'h2'} noWrap>
                      {parseFloat(dashboard.portfolio_growth_eth_weekly.toFixed(2)).toLocaleString()}
                    </Typography>
                    <Typography className={classes.symbol} variant={'h3'}>
                      ETH
                    </Typography>
            ...
            {growth === 2 && (
              <div className={classes.titleBalance} onClick={this.growthClicked}>
                {currency === 'USD' && (
                  <Typography variant={'h2'}>
                    $ {parseFloat(dashboard.portfolio_growth_usd_yearly.toFixed(2)).toLocaleString()}
                  </Typography>
                )}
                {currency === 'ETH' && (
                  <div className={classes.inline}>
                    <Typography variant={'h2'} noWrap>
                      {parseFloat(dashboard.portfolio_growth_eth_yearly.toFixed(2)).toLocaleString()}
                    </Typography>
                    <Typography className={classes.symbol} variant={'h3'}>
                      ETH
                    </Typography>
        ...
        <div className={classes.vault} key={asset.id}>
          <div className={classes.assetSummary}>
            ...
            {growth === 0 && (
              <div className={classes.heading}>
                ...
                {currency === 'USD' && (
                  <div className={classes.inline}>
                    <Typography variant={'h3'} noWrap>
                      $ {parseFloat(asset.vaultGrowth_daily_usd.toFixed(2)).toLocaleString()}
                    </Typography>
                    ...
                    <Typography className={classes.symbol} variant={'h4'}>
                      {' '}
                      {asset.apy ? (asset.apy / 365).toFixed(2) : '0.00'}%
                    </Typography>
                  </div>
                )}
                {currency === 'ETH' && (
                  <div className={classes.inline}>
                    <Typography variant={'h3'} noWrap>
                      {parseFloat(asset.vaultGrowth_daily_eth.toFixed(2)).toLocaleString()}
                    </Typography>
                    <Typography className={classes.symbol} variant={'h4'}>
                      ETH
                    </Typography>
            ...
            {growth === 1 && (
              <div className={classes.heading}>
                ...
                {currency === 'USD' && (
                  <div className={classes.inline}>
                    <Typography variant={'h3'} noWrap>
                      $ {parseFloat(asset.vaultGrowth_weekly_usd.toFixed(2)).toLocaleString()}
                    </Typography>
                    <Typography className={classes.symbolAt} variant={'h4'}>
                      {' '}
                      @{' '}
                    ...
                    <Typography className={classes.symbol} variant={'h4'}>
                      {' '}
                      {asset.apy ? (asset.apy / 52).toFixed(2) : '0.00'}%
                    </Typography>
                  </div>
                )}
                {currency === 'ETH' && (
                  <div className={classes.inline}>
                    <Typography variant={'h3'} noWrap>
                      {parseFloat(asset.vaultGrowth_weekly_eth.toFixed(2)).toLocaleString()}
                    </Typography>
                    <Typography className={classes.symbol} variant={'h4'}>
                      ETH
                    </Typography>
            ...
            {growth === 2 && (
              <div className={classes.heading}>
                ...
                {currency === 'USD' && (
                  <div className={classes.inline}>
                    <Typography variant={'h3'} noWrap>
                      $ {parseFloat(asset.vaultGrowth_yearly_usd.toFixed(2)).toLocaleString()}
                    </Typography>
                    <Typography className={classes.symbolAt} variant={'h4'}>
                      {' '}
                      @{' '}
                    ...
                    <Typography className={classes.symbol} variant={'h4'}>
                      {' '}
                      {asset.apy ? (asset.apy / 1).toFixed(2) : '0.00'}%
                    </Typography>
                  </div>
                )}
                {currency === 'ETH' && (
                  <div className={classes.inline}>
                    <Typography variant={'h3'} noWrap>
                      {parseFloat(asset.vaultGrowth_yearly_eth.toFixed(2)).toLocaleString()}
                    </Typography>
                    <Typography className={classes.symbol} variant={'h4'}>
                      ETH
                    </Typography>
            ...
            <div className={classes.heading}>
              ...
              {currency === 'USD' && (
                <Typography variant={'h3'} noWrap>
                  $ {parseFloat(asset.usdBalance ? asset.usdBalance.toFixed(2) : '0.00').toLocaleString()}
                </Typography>
              )}
              {currency === 'ETH' && (
                <div className={classes.inline}>
                  <Typography variant={'h3'} noWrap>
                    {parseFloat(asset.ethBalance ? asset.ethBalance.toFixed(2) : '0.00').toLocaleString()}
                  </Typography>
                  <Typography className={classes.symbol} variant={'h4'}>
                    ETH
                  </Typography>
            ...
            {growth === 0 && (
              <div className={classes.heading}>
                ...
                {currency === 'USD' && (
                  <div className={classes.inline}>
                    <Typography variant={'h3'} noWrap>
                      $ {parseFloat(asset.earnGrowth_daily_usd.toFixed(2)).toLocaleString()}
                    </Typography>
                    <Typography className={classes.symbolAt} variant={'h4'}>
                      {' '}
                      @{' '}
                    ...
                    <Typography className={classes.symbol} variant={'h4'}>
                      {' '}
                      {asset.maxApr ? ((asset.maxApr * 100) / 365).toFixed(2) : '0.00'}%
                    </Typography>
                  </div>
                )}
                {currency === 'ETH' && (
                  <div className={classes.inline}>
                    <Typography variant={'h3'} noWrap>
                      {parseFloat(asset.earnGrowth_daily_eth.toFixed(2)).toLocaleString()}
                    </Typography>
                    <Typography className={classes.symbol} variant={'h4'}>
                      ETH
                    </Typography>
            ...
            {growth === 1 && (
              <div className={classes.heading}>
                ...
                {currency === 'USD' && (
                  <div className={classes.inline}>
                    <Typography variant={'h3'} noWrap>
                      $ {parseFloat(asset.earnGrowth_weekly_usd.toFixed(2)).toLocaleString()}
                    </Typography>
                    <Typography className={classes.symbolAt} variant={'h4'}>
                      {' '}
                      @{' '}
                    ...
                    <Typography className={classes.symbol} variant={'h4'}>
                      {' '}
                      {asset.maxApr ? ((asset.maxApr * 100) / 52).toFixed(2) : '0.00'}%
                    </Typography>
                  </div>
                )}
                {currency === 'ETH' && (
                  <div className={classes.inline}>
                    <Typography variant={'h3'} noWrap>
                      {parseFloat(asset.earnGrowth_weekly_eth.toFixed(2)).toLocaleString()}
                    </Typography>
                    <Typography className={classes.symbol} variant={'h4'}>
                      ETH
                    </Typography>
            ...
            {growth === 2 && (
              <div className={classes.heading}>
                ...
                {currency === 'USD' && (
                  <div className={classes.inline}>
                    <Typography variant={'h3'} noWrap>
                      $ {parseFloat(asset.earnGrowth_yearly_usd.toFixed(2)).toLocaleString()}
                    </Typography>
                    <Typography className={classes.symbolAt} variant={'h4'}>
                      {' '}
                      @{' '}
                ...
                {currency === 'ETH' && (
                  <div className={classes.inline}>
                    <Typography variant={'h3'} noWrap>
                      {parseFloat(asset.earnGrowth_yearly_eth.toFixed(2)).toLocaleString()}
                    </Typography>
                    <Typography className={classes.symbol} variant={'h4'}>
                      ETH
                    </Typography>
