  ...
  page: {
    ...
    filter: {
      ...
      input: {
        ...
        hoverShadow: 'inset 0px -1px 0px #40A9FF',
      },
      sort: {
        option: '#000',
        arrow: '6px solid #AEB7C6',
        label: '#AEB7C6',
        select: '#fff',
      },
    },
    asset: {
      ...
      input: {
        bg: '#1D2430',
        border: '1px solid #40A9FF',
        shadow: '0px 0px 14px rgba(64, 169, 255, 0.6)',
        color: '#FFF',
      },
      balance: '#FFF',
      button: {
      ...
      slider: {
        ...
        rail: '#394861',
        track: 'linear-gradient(100.35deg, #369EFF 0%, #096DD9 100%)',
        mark: '#818FA6',
        activeMark: '#BAE7FF',
        thumb: {
          bg: '#BAE7FF',
        ...
        value: {
          color: '#fff',
          glow: 'rgb(64, 169, 255) 0px 0px 10px',
        },
      },
    },
  },
